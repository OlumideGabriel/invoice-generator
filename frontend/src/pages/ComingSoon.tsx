    ...
    <div className="h-full bg-white max-h-100dvh justify-center items-center text-gray-900 overflow-x-hidden flex flex-col">
      <div className="max-w-md w-full bg-white text-center">
        ...
        <div className=" rounded-lg p-4 mb-6">
          <a
          href="mailto:support@envoyce.xyz"
          className="w-full bg-white border border-gray-300 py-3 px-4 rounded-lg
          hover:bg-gray-100 transition-colors font-medium flex items-center justify-center"
        >
          <Mail className="h-5 w-5 text-gray-600 mr-2" />
          <span className="text-gray-800 font-medium">Message us here</span>
        </a>
        </div>
