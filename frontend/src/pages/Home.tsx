        ...
        <div className="h-full bg-[#f6f4ed] max-h-100dvh  text-gray-900 overflow-x-hidden justify-between flex flex-col">
            ...
            <section className="flex items-center mx-auto px-2 md:px-16">
                <div className="flex flex-col md:flex-row items-center w-full mx-auto">
                    ...
                    <span className="text-md font-medium text-gray-500 mb-6 inline-block bg-black/5 px-2 py-1 rounded-full">
                    <div className="avatar avatar-sm mr-2 inline-block">
                        <img
                            ...
                            alt="Envoyce Logo"
                            className="rounded-full object-cover w-6 h-6 md:w-7 md:h-7 inline-block border-2 border-white"
