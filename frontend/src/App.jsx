...
function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-white px-6 py-12 flex justify-center items-center">
      <div className="max-w-4xl w-full bg-neutral-800 shadow-xl rounded-2xl p-8 overflow-auto">
        <h1 className="text-3xl font-bold mb-6 text-indigo-400">Invoice Generator</h1>
        ...
        <ItemDescriptions items={items} handleChange={handleChange} />
