...
const MainMenu: React.FC<MainMenuProps> = ({
  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between main-menu mx-2 px-4 py-3">
          <div className="flex items-center space-x-6">
            {showLogo && (
              <Link
                to="/"
                className="flex items-start gap-1 hover:contrast-125"
              >
                <img
                  src="/envoyce.svg"
                  alt="Envoyce Logo"
          ...
          {user ? (
            <div className="hidden md:flex relative z-50" ref={menuRef}>
              ...
              >
                ...
                <Bell
                  className="self-center w-11 h-11 p-3 rounded-full text-gray-400
              ...
              {open && (
                <div
                  className="absolute min-w-80 right-0 top-10 mt-2 bg-white rounded-md overflow-hidden z-50
      ...
      <div
        className={`fixed inset-0 z-50 md:hidden transition-opacity duration-300 ease-in-out ${mobileMenuOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}
      >
