...
export default function Advert() {
  ...
  return (
      <a href="https://medium.com/@talktoolumide/it-started-with-a-familiar-pain-point-f33f26b85d3a" target="_blank" rel="noopener noreferrer" className="flex items-start z-10 w-full">
    <div className="flex items-start z-10 w-full">
      <div className="bg-[#8eda91] hover:bg-[#8eda91]/60 shadow-xs hidden xl:block p-4 hover:shadow-sm transition-all duration-500 ease-in-out relative">
        {/* Close Button */}
        <button
        ...
        <div className="flex items-center gap-2 mb-3 pr-6">
          <h3 className="font-semibold text-[#0e423e]">We Got 500+ Users</h3>
        </div>
        ...
        {/* Price */}
        <div className="text-left px-2.5 py-0.5 bg-black/20 rounded-full !font-medium text-xs text-[#132a29] w-fit -mb-1 mt-4">
          Article on medium
        </div>
      </div>
